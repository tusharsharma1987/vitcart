...
var colsConfig = [
		{ id : 'title'      , header : "title" , width : 250 , editable:false },
...
var gridConfig={
	...
	toolbarContent : 'nav | goto | pagesize | pdf' ,
...
<div id="test_div">this is the test of </div>
<?php
include 'footer.php';
?>
<script language="javascript">
	...
	function test_div(id)
		{
			document.getElementById("test_div").innerHTML="tushar sharma";	
		}
</script>